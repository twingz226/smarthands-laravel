...
<head>
  ...
  <meta name="description" content="Privacy Policy for Smarthands Cleaning Services. Learn how we collect, use, and protect your personal information when you book our cleaning services.">
  ...
  <title>Privacy Policy | Smarthands Cleaning Services</title>
...
@endphp
  ...
  <section class="hero-section">
    <h1 class="main-headline">Privacy Policy</h1>
  </section>
  ...
  <section class="content-section">
    <div class="container">
      <div class="policy-card">
        ...
        <p><strong>At SMARTHANDS House Cleaning Services, we value your privacy.</strong> The information we collect from you is used solely for booking and service purposes. We may ask for your full name, exact location or address, contact number, and in some cases, house pictures if needed for assessment.</p>

        <p>This information is used only to confirm and schedule bookings, provide accurate quotations, and communicate with you regarding your cleaning service. We do not share, sell, or disclose your information to any third party. All details you provide are kept strictly confidential and used only for the purpose of delivering our services.</p>

        <p>In some cases, our team may take pictures during or after cleaning. However, this will always be subject to your approval. We will ask for your permission first before posting any photos on our Facebook page or other social media platforms.</p>

        <p>We are committed to protecting your privacy and ensuring that your personal information remains safe with us.</p>
      </div>
    </div>
  </section>
  </main>
        ...
        <form id="profileForm" method="POST" action="{{ url('/customer/profile') }}">
          ...
          <div class="modal-body">
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="privacy_name" name="name" value="{{ Auth::user()->name ?? '' }}">
                  <div class="invalid-feedback" id="error-name"></div>
              </div>
              <div class="mb-3">
                  <label for="email" class="form-label">Email</label>
                  <input type="email" class="form-control" id="privacy_email" name="email" value="{{ Auth::user()->email ?? '' }}">
