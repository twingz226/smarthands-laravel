...
<head>
  ...
  <meta name="description" content="Contact Smarthands Cleaning Services in Bacolod City. Reach us by phone, email, or visit our office for reliable and professional cleaning solutions.">
  <meta name="csrf-token" content="{{ csrf_token() }}">

  <!-- Open Graph / Facebook -->
  <meta property="og:type" content="website">
  <meta property="og:url" content="{{ url()->current() }}">
  <meta property="og:title" content="Contact Us | Smarthands Cleaning Services">
  <meta property="og:description" content="Contact Smarthands Cleaning Services in Bacolod City. Reach us by phone, email, or visit our office.">
  <meta property="og:image" content="{{ asset('images/og-image.jpg') }}">

  <!-- Twitter -->
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Contact Us | Smarthands Cleaning Services">
  <meta name="twitter:description" content="Contact Smarthands Cleaning Services in Bacolod City. Reach us by phone, email, or visit our office.">
  <meta name="twitter:image" content="{{ asset('images/og-image.jpg') }}">

  <!-- Canonical URL -->
  <link rel="canonical" href="{{ url()->current() }}" />

  <title>Contact Us | Smarthands Cleaning Services in Bacolod</title>
...
<body>
  ...
  {!! json_encode([
    ...
    '@type' => 'ContactPage',
    'name' => 'Contact Smarthands Cleaning Services',
    'description' => 'Contact information for Smarthands Cleaning Services in Bacolod City',
    'url' => url()->current(),
    'mainEntity' => [
      '@type' => 'LocalBusiness',
      ...
      <form id="profileForm" method="POST" action="{{ url('/customer/profile') }}">
        ...
        <div class="modal-body">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="contact_name" name="name" value="{{ Auth::user()->name ?? '' }}">
                <div class="invalid-feedback" id="error-name"></div>
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">Email</label>
                <input type="email" class="form-control" id="contact_email" name="email" value="{{ Auth::user()->email ?? '' }}">
