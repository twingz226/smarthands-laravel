  ...
  <section class="content-section">
    <div class="container">
      <div class="policy-card">
        ...
        <h3>5. Contact</h3>
        <p>If you have questions about our Cookie Policy, contact us at {{ $contactInfo->email ?? 'smarthandsbcd@gmail.com' }}.</p>
      </div>
    </div>
  </section>
        ...
        <form id="profileForm" method="POST" action="{{ url('/customer/profile') }}">
          ...
          <div class="modal-body">
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="cookies_name" name="name" value="{{ Auth::user()->name ?? '' }}">
                  <div class="invalid-feedback" id="error-name"></div>
              </div>
              <div class="mb-3">
                  <label for="email" class="form-label">Email</label>
                  <input type="email" class="form-control" id="cookies_email" name="email" value="{{ Auth::user()->email ?? '' }}">
