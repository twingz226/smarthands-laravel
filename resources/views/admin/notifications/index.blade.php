...
@endphp
                            <a href="{{ $data['link'] ?? '#' }}" class="list-group-item notification-item" data-id="{{ $notification->id }}">
                                <div class="media">
                                    <div class="media-left">
                                        <i class="notification-icon {{ $iconClass }}" style="font-size: 24px; color: #3498db;"></i>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="media-heading notification-message">{{ $data['message'] ?? 'New notification' }}</h4>
