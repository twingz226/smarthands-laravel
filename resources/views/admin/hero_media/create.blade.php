  ...
  <div class="col-sm-10 col-sm-offset-1">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <div class="panel-title">New Homepage Banner</div>
      </div>
      <div class="panel-body">
        <form method="POST" action="{{ route('admin.hero_media.store') }}">
          @csrf
          <div class="row">
            <div class="col-md-6">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="media_path" value="{{ old('media_path') }}" placeholder="E.g., clean.mp4 or https://..." required>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="poster_image" value="{{ old('poster_image') }}" placeholder="E.g., images/hero-poster.jpg or https://...">
              </div>
            </div>
          </div>
