            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <p class="text-muted">{{ $booking->service->name }}</p>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Current Date:</label>
                        <p class="text-muted">{{ $booking->cleaning_date->format('Y-m-d') }}</p>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Current Time:</label>
                        <p class="text-muted">{{ $booking->cleaning_date->format('g:i A') }}</p>
                    </div>
