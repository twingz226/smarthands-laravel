        ...
        <ul class="user-info pull-left pull-right xs-pull-left">
            <li class="messages dropdown" style="margin-right: 18px;">
                ...
                <ul class="dropdown-menu notifications-dropdown" style="color:#000 !important;">
                    ...
                    <li class="external">
                        <a href="{{ route('admin.contact_messages.index') }}" style="color:#000 !important;">View all messages</a>
                    </li>
                </ul>
            </li>
            <li class="trash-link" style="margin-right: 18px;">
                <a href="{{ route('admin.trash.index') }}" class="dropdown-toggle d-flex align-items-center" title="View Deleted Actions" style="color:#5d5d5d;">
