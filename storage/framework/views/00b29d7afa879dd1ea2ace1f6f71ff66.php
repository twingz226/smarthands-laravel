...
<head>
  ...
  <link rel="icon" href="<?php echo e(asset('images/Smarthands.png')); ?>" type="image/png" />
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light custom-navbar shadow-sm sticky-top">
    <div class="container">
      <a class="navbar-brand" href="<?php echo e(route('home')); ?>" aria-label="Smarthands Cleaning Services Home">
      ...
      <?php if(isset($heroMedia) && $heroMedia): ?>
        <?php if($heroMedia->media_type === 'video'): ?>
          <video class="hero-video" autoplay loop playsinline muted 
                 <?php if($heroMedia->poster_url): ?> poster="<?php echo e($heroMedia->poster_url); ?>" <?php endif; ?>
        ...
        <?php elseif($heroMedia->media_type === 'image'): ?>
          <img class="hero-image img-fluid" 
               src="<?php echo e($heroMedia->media_url); ?>" 
        ...
        <?php if($servicesMedia->isNotEmpty()): ?>
          <?php $__currentLoopData = $servicesMedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="service-box">
              <img src="<?php echo e($service->media_url); ?>" 
                   alt="<?php echo e($service->title); ?> service"
                   class="img-fluid"
                   width="400"
                   height="300"
                   loading="lazy">
...
unset($__errorArgs, $__bag); ?>" value="<?php if(auth()->guard()->check()): ?><?php echo e(Auth::user()->name); ?><?php else: ?><?php echo e(old('name')); ?><?php endif; ?>" <?php if(auth()->guard()->check()): ?> readonly <?php endif; ?> required>
