  ...
  <nav class="navbar navbar-expand-lg navbar-light custom-navbar shadow-sm sticky-top">
    <div class="container">
      <a class="navbar-brand" href="<?php echo e(route('home')); ?>">
        ...
        ?>
        <img src="<?php echo e($companyLogo ? asset('storage/' . $companyLogo) : asset('images/Smarthands.png')); ?>" alt="Logo" onerror="this.src='https://via.placeholder.com/100'" class="img-fluid">
      </a>
        ...
        <div class="col-lg-8">
          ...
          <div class="info-card mb-4">
            ...
            <div class="mission-content">
              <?php echo e($contactInfo->mission ?? 'To provide exceptional cleaning services that enhance the quality of life for our clients while maintaining the highest standards of professionalism and customer satisfaction.'); ?>
          ...
          <div class="info-card mb-4">
            ...
            <div class="vision-content">
              <?php echo e($contactInfo->vision ?? 'To be the leading cleaning service provider in Bacolod City, known for our reliability, quality, and commitment to excellence.'); ?>
          ...
          <div class="info-card">
            ...
            <div class="info-item">
              ...
              <?php echo e($contactInfo->service_area ?? 'Silay City, Philippines · Talisay, Philippines · Bacolod City, Philippines'); ?>
      ...
      <form id="profileForm" method="POST" action="<?php echo e(url('/customer/profile')); ?>">
        ...
        <div class="modal-body">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="about_name" name="name" value="<?php echo e(Auth::user()->name ?? ''); ?>">
                <div class="invalid-feedback" id="error-name"></div>
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">Email</label>
                <input type="email" class="form-control" id="about_email" name="email" value="<?php echo e(Auth::user()->email ?? ''); ?>">
...
</html><?php /**PATH /opt/lampp/htdocs/cleaning_service_management_system/resources/views/pages/about.blade.php ENDPATH**/ ?>