        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="<?php echo e($headingId); ?>">
            <button class="accordion-button <?php echo e($isFirst ? '' : 'collapsed'); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#<?php echo e($collapseId); ?>">
              <i class="<?php echo e($icon); ?>"></i> <?php echo e($service->name); ?>
      ...
      <form id="profileForm" method="POST" action="<?php echo e(url('/customer/profile')); ?>">
        ...
        <div class="modal-body">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="services_name" name="name" value="<?php echo e(Auth::user()->name ?? ''); ?>">
                <div class="invalid-feedback" id="error-name"></div>
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">Email</label>
                <input type="email" class="form-control" id="services_email" name="email" value="<?php echo e(Auth::user()->email ?? ''); ?>">
...
<?php /**PATH /opt/lampp/htdocs/cleaning_service_management_system/resources/views/pages/services.blade.php ENDPATH**/ ?>