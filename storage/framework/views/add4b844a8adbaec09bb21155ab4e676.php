...
<head>
  ...
  <title>Terms & Conditions - Smarthands</title>
        ...
        <form id="profileForm" method="POST" action="<?php echo e(url('/customer/profile')); ?>">
          ...
          <div class="modal-body">
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="terms_name" name="name" value="<?php echo e(Auth::user()->name ?? ''); ?>">
                  <div class="invalid-feedback" id="error-name"></div>
              </div>
              <div class="mb-3">
                  <label for="email" class="form-label">Email</label>
                  <input type="email" class="form-control" id="terms_email" name="email" value="<?php echo e(Auth::user()->email ?? ''); ?>">
...
<?php /**PATH /opt/lampp/htdocs/cleaning_service_management_system/resources/views/pages/terms.blade.php ENDPATH**/ ?>