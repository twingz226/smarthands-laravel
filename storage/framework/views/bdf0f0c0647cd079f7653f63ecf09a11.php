  ...
  <section class="contact-section">
    ...
    <div class="contact-card">
      ...
      <div class="contact-item">
        ...
        <?php echo e($contactInfo->address ?? 'Bacolod City, Philippines, 6100'); ?>
      ...
      <form id="profileForm" method="POST" action="<?php echo e(url('/customer/profile')); ?>">
        ...
        <div class="modal-body">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="contact_name" name="name" value="<?php echo e(Auth::user()->name ?? ''); ?>">
                <div class="invalid-feedback" id="error-name"></div>
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">Email</label>
                <input type="email" class="form-control" id="contact_email" name="email" value="<?php echo e(Auth::user()->email ?? ''); ?>">
...
</html><?php /**PATH /opt/lampp/htdocs/cleaning_service_management_system/resources/views/pages/contact.blade.php ENDPATH**/ ?>