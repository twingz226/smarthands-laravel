    ...
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #e7f3ff; padding: 15px; border-radius: 5px; margin-bottom: 20px; border-left: 4px solid #007bff;">
            ...
            <ul style="list-style: none; padding: 0; margin: 0;">
                <?php $__currentLoopData = $cleaners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li style="display: flex; align-items: center; margin-bottom: 15px;">
                        <?php if($employee->getPrimaryPhotoUrl()): ?>
                            <img src="<?php echo e($employee->getPrimaryPhotoUrl()); ?>" alt="<?php echo e($employee->name); ?>" style="width: 100px; height: 100px; border-radius: 50%; object-fit: cover; border: 2px solid #007bff; margin-right: 15px;">
                        <?php endif; ?>
                        <div>
                            <strong><?php echo e($employee->name); ?></strong><br>
                            <span style="font-size: 14px; color: #555;">Phone: <?php echo e($employee->phone); ?></span>
                        </div>
                    </li>
        ...
        <div style="background: #f8f9fa; padding: 15px; border-radius: 5px; margin: 20px 0;">
            ...
            <p><strong>Scheduled Date:</strong> <?php echo e($job->scheduled_date->format('M d, Y H:i')); ?></p>
            <p><strong>Location:</strong> <?php echo e($job->address ?? $job->customer->address); ?></p>
            <?php if($job->special_instructions): ?>
                <p><strong>Special Instructions:</strong> <?php echo e($job->special_instructions); ?></p>
            <?php endif; ?>
        </div>
                    ...
                    <div style="display: flex; align-items: start; gap: 15px;">
                        <?php if($employee->getPrimaryPhotoUrl()): ?>
                            <div style="flex-shrink: 0;">
                                <img src="<?php echo e($employee->getPrimaryPhotoUrl()); ?>" 
                                     alt="<?php echo e($employee->name); ?>" 
                                     style="width: 140px; height: 140px; border-radius: 50%; object-fit: cover; border: 2px solid #007bff;">
                            </div>
                        <?php endif; ?>
                        <div style="flex-grow: 1;">
                            <h4 style="margin: 0 0 8px 0; color: #333;"><?php echo e($employee->name); ?></h4>
                            <p style="margin: 5px 0;"><strong>Phone:</strong> <?php echo e($employee->phone); ?></p>
                            <p style="margin: 5px 0;"><strong>Address:</strong> <?php echo e($employee->address); ?></p>
                        </div>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
</html> <?php /**PATH /opt/lampp/htdocs/cleaning_service_management_system/resources/views/emails/jobs/cleaner_assigned.blade.php ENDPATH**/ ?>